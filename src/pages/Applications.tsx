                    ...
                    <div className="flex items-center gap-3 min-w-0 pr-2">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-[11px] text-[#6b7589] flex items-center gap-2 mt-0.5 truncate">
                          <span>Source Type: {app.targetType === 'folder' ? 'Project Folder' : app.targetType === 'binary' ? 'Binary / Library' : app.targetType === 'container' ? 'Container Image' : 'Source Repository'}</span>
                        </div>
                      </div>
                    </div>
